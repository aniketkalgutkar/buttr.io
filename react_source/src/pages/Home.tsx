...
function Home() {
    ...
    return (<>
        ...
        {/*<!-- ======= Header =======--> */}
        <header className="fbs__net-navbar navbar navbar-expand-lg relative dark" aria-label="freebootstrap.net navbar">
            <div className="container d-flex align-items-center justify-content-between">
            
            
            {/*<!-- Start Logo--> */}
            <a className="navbar-brand w-auto" href="page-index.html">
            ...
            <div className="offcanvas offcanvas-start w-75" id="fbs__net-navbars" tabIndex={-1} aria-labelledby="fbs__net-navbarsLabel">
                ...
                <div className="offcanvas-header-logo">
                    ...
                    {/*<!-- If you plan to use an image logo, uncomment this if it is commented--> */}
                    <a className="logo-link" id="fbs__net-navbarsLabel" href="page-index.html" />
                ...
                <ul className="navbar-nav nav me-auto ps-lg-5 mb-2 mb-lg-0">
                    <li className="nav-item"><a className="nav-link scroll-link active" aria-current="page" href="page-index.html">Home</a></li>
                    <li className="nav-item"><a className="nav-link scroll-link" href="page-about.html">About</a></li>
                    <li className="nav-item dropdown dropdown-mega-menu"><a className="nav-link dropdown-toggle" id="megaMenuDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Pages<i className="bi bi-chevron-down">  </i></a>
                    
                    {/*<!-- ======= Megamenu =======--> */}
                    <div className="dropdown-menu mega-menu" aria-labelledby="megaMenuDropdown">
                        <div className="container">
                        <div className="row">
                            <div className="col-lg-4 mb-4 mb-lg-0"><img className="img-fluid object-fit-cover w-100 rounded-3" style={{"height": "370px"}} src="assets/images/img-7-min.jpg" alt="FreeBootstrap.net Image placeholder" /></div>
                                ...
                                <div className="row g-2">
                                    ...
                                    <div className="row g-2">
                                        ...
                                        <ul className="list-unstyled">
                                            ...
                                            <li><a className="dropdown-item" href="page-case-studies.html">Case Studies</a></li>
                                            <li><a className="dropdown-item" href="page-case-study.html">Case Study</a></li>
                                            <li><a className="dropdown-item" href="page-pricing.html">Pricing</a></li>
                                            <li><a className="dropdown-item" href="page-careers.html">Careers</a></li>
                                            <li><a className="dropdown-item" href="page-careers-single.html">Careers Single</a></li>
                                            <li><a className="dropdown-item" href="page-contact.html">Contact </a></li>
                                        </ul>
                                        </div>
                                        <div className="col-lg-4 mb-4 mb-lg-0">
                                        <h5 className="ms-2">Blog</h5>
                                        <ul className="list-unstyled">
                                            <li><a className="dropdown-item" href="page-blog-list.html">Blog List</a></li>
                                            <li><a className="dropdown-item" href="page-blog-grid.html">Blog Grid</a></li>
                                            <li><a className="dropdown-item" href="page-blog-modern.html">Blog Modern</a></li>
                                            <li><a className="dropdown-item" href="page-blog-single.html">Blog Single</a></li>
                                            <li><a className="dropdown-item" href="page-blog-category.html">Blog Category</a></li>
                                            <li><a className="dropdown-item" href="page-author-profile.html">Author Profile</a></li>
                                        </ul>
                                        </div>
                                        <div className="col-lg-4 mb-4 mb-lg-0">
                                        <h5 className="ms-2">Onepage</h5>
                                        <ul className="list-unstyled">
                                            <li><a className="dropdown-item" href="index.html">Homepage</a></li>
                                        </ul>
                                        <h5 className="ms-2 mt-4">Portfolio</h5>
                                        <ul className="list-unstyled">
                                            <li><a className="dropdown-item" href="page-portfolio-list.html">Portfolio List</a></li>
                                            <li><a className="dropdown-item" href="page-portfolio-grid.html">Portfolio Grid</a></li>
                                            <li><a className="dropdown-item" href="page-portfolio-masonry.html">Portfolio Masonry</a></li>
                                            <li><a className="dropdown-item" href="page-portfolio-single.html">Portfolio Single </a></li>
                                        </ul>
                                        </div>
                                    </div>
                                    </div>
                                    <div className="col-lg-4 mb-0 mb-lg-0">
                                    <h5 className="ms-2">Specialty Pages</h5>
                                    <ul className="list-unstyled">
                                        <li><a className="dropdown-item" href="page-coming-soon.html">Coming Soon</a></li>
                                        <li><a className="dropdown-item" href="page-terms-conditions.html">Terms & Conditions</a></li>
                                        <li><a className="dropdown-item" href="page-privacy-policy.html">Privacy Policy</a></li>
                                        <li><a className="dropdown-item" href="page-404.html">404 Page</a></li>
                                    </ul>
                                    <h5 className="ms-2 mt-4">Auth</h5>
                                    <ul className="list-unstyled">
                                        <li><a className="dropdown-item" href="page-signin.html">Sign in</a></li>
                                        <li><a className="dropdown-item" href="page-signup.html">Register</a></li>
                                        <li><a className="dropdown-item" href="page-forgot-password.html">Forgot Password</a></li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
                    ...
                    <li className="nav-item dropdown"><a className="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">Dropdown <i className="bi bi-chevron-down"></i></a>
                    
                    <ul className="dropdown-menu">
                        <li><a className="nav-link scroll-link dropdown-item" href="index.html">Onepage</a></li>
                        <li><a className="nav-link scroll-link dropdown-item" href="page-services.html">Services</a></li>
                        <li><a className="nav-link scroll-link dropdown-item" href="page-pricing.html">Pricing</a></li>
                        <li className="nav-item dropstart"><a className="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">Dropstart <i className="bi bi-chevron-right"></i></a>
                        <ul className="dropdown-menu">
                            <li><a className="nav-link scroll-link dropdown-item" href="page-blog.html">Blog</a></li>
                            <li><a className="nav-link scroll-link dropdown-item" href="page-blog-single.html">Blog Single</a></li>
                            <li className="nav-item dropstart"><a className="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">Dropstart <i className="bi bi-chevron-right"></i></a>
                            <ul className="dropdown-menu">
                                <li><a className="nav-link scroll-link dropdown-item" href="page-about.html">About</a></li>
                                <li><a className="nav-link scroll-link dropdown-item" href="page-faq.html">FAQ</a></li>
                                <li><a className="nav-link scroll-link dropdown-item" href="page-blog.html">Blog Single</a></li>
                                <li className="nav-item dropend"><a className="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">Dropend <i className="bi bi-chevron-right"></i></a>
                                <ul className="dropdown-menu">
                                    <li><a className="nav-link scroll-link dropdown-item" href="page-blog-list.html">Blog List</a></li>
                                    <li><a className="nav-link scroll-link dropdown-item" href="#page-blog-grid.html">Blog Grid</a></li>
                                    <li><a className="nav-link scroll-link dropdown-item" href="page-blog-modern.html">Blog Modern</a></li>
                                </ul>
                                </li>
                            </ul>
                            </li>
                    ...
                    <li className="nav-item"><a className="nav-link scroll-link" href="page-contact.html">Contact </a></li>
                </ul>
            ...
            <div className="ms-auto w-auto">
                ...
                <a id="themeToggleBtn" href="#"><i className="bi" id="themeIcon"></i></a>
        ...
        <main>
            ...
            <div className="container">
                ...
                <div className="col-md-5 mx-auto text-center"><span className="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Pricing</span>
                ...
                <div className="col-md-8" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div className="row">
                        ...
                        <ul className="list-unstyled d-flex flex-column gap-3">
                            <li className="d-flex gap-2 align-items-start mb-0"><span className="icon rounded-circle position-relative mt-1"><i className="bi bi-check"></i></span><span>Personalized financial insights and reports</span></li>
                            <li className="d-flex gap-2 align-items-start mb-0"><span className="icon rounded-circle position-relative mt-1"><i className="bi bi-check"></i></span><span>Priority customer support</span></li>
                            <li className="d-flex gap-2 align-items-start mb-0"><span className="icon rounded-circle position-relative mt-1"><i className="bi bi-check"></i></span><span>Access to exclusive investment opportunities</span></li>
                            <li className="d-flex gap-2 align-items-start mb-0"><span className="icon rounded-circle position-relative mt-1"><i className="bi bi-check"></i></span><span>AI-driven financial recommendations</span></li>
                        </ul>
                        </div>
                    </div>
                    </div>
            ...
            <div className="container">
                ...
                <div className="col-12">
                    ...
                    <div className="col-12 col-sm-6 col-md-4 mb-4 mb-md-0 text-center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <h3 className="fs-1 fw-bold"><span className="purecounter" data-purecounter-start="0" data-purecounter-end="10" data-purecounter-duration="2">0</span><span>K+</span></h3>
                    ...
                    <div className="col-12 col-sm-6 col-md-4 mb-4 mb-md-0 text-center" data-aos="fade-up" data-aos-delay="200">
                        <div className="stat-item">
                        <h3 className="fs-1 fw-bold"> <span className="purecounter" data-purecounter-start="0" data-purecounter-end="200" data-purecounter-duration="2">0</span><span>%+</span></h3>
                    ...
                    <div className="col-12 col-sm-6 col-md-4 mb-4 mb-md-0 text-center" data-aos="fade-up" data-aos-delay="300">
                        <div className="stat-item">
                        <h3 className="fs-1 fw-bold"><span className="purecounter" data-purecounter-start="0" data-purecounter-end="20" data-purecounter-duration="2">0</span><span>x</span></h3>
            ...
            <div className="container">
                <div className="row mb-5">
                <div className="col-md-8 mx-auto text-center"><span className="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Our Services</span>
                    <h2 className="mb-3" data-aos="fade-up" data-aos-delay="100">Empowering Financial Innovation Through Cutting-Edge Services</h2>
                </div>
                </div>
                ...
                <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <div><span className="icon mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" x="0" y="0" viewBox="0 0 64 64" enableBackground="new 0 0 512 512" xmlSpace="preserve">
                            <g>
                        ...
                        <p className="mb-4">Seamless and secure transactions through various digital platforms, enabling quick and convenient payments for businesses and consumers alike.</p>
                    </div><a className="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span className="icons"><i className="icon-1 bi bi-arrow-right-short"></i><i className="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                    </div>
                </div>
                ...
                <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div><span className="icon mb-4">
                        ...
                        <p className="mb-4">Fast and accessible lending services that provide personal and business loans through online platforms, simplifying the borrowing process.</p>
                    </div><a className="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span className="icons"><i className="icon-1 bi bi-arrow-right-short"></i><i className="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                    </div>
                </div>
                <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div><span className="icon mb-4">
                        ...
                        <p className="mb-4">User-friendly platforms that allow individuals to invest in stocks, bonds, and other assets with minimal barriers, making investment accessible to all.</p>
                    </div><a className="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span className="icons"><i className="icon-1 bi bi-arrow-right-short"></i><i className="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                    </div>
                </div>
                <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div><span className="icon mb-4">
                        ...
                        <p className="mb-4">Services that facilitate the buying, selling, and trading of cryptocurrencies, offering users a gateway to the digital currency market.</p>
                    </div><a className="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span className="icons"><i className="icon-1 bi bi-arrow-right-short"></i><i className="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                    </div>
                </div>
                <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <div><span className="icon mb-4">
                        ...
                        <p className="mb-4">Innovative insurance services that leverage technology to offer personalized policies, faster claims processing, and enhanced customer experiences.</p>
                    </div><a className="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span className="icons"><i className="icon-1 bi bi-arrow-right-short"></i><i className="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                    </div>
                </div>
                </div>
            ...
            <div className="container">
                <div className="row mb-5">
                <div className="col-lg-5 mx-auto text-center"><span className="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Testimonials</span>
                ...
                <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <div className="testimonial-author d-flex gap-3 align-items-center">
                        <div className="author-img"><img className="rounded-circle img-fluid" src="assets/images/person-sq-2-min.jpg" alt="FreeBootstrap.net image placeholder" /></div>
                        <div className="lh-base"><strong className="d-block">John Davis</strong><span>Small Business Owner</span></div>
                    </div>
                    </div>
                </div>
                <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div className="testimonial-author d-flex gap-3 align-items-center">
                        <div className="author-img"><img className="rounded-circle img-fluid" src="assets/images/person-sq-1-min.jpg" alt="FreeBootstrap.net image placeholder" /></div>
                        <div className="lh-base"><strong className="d-block">Emily Smith</strong><span>Freelancer</span></div>
                    </div>
                    </div>
                </div>
                <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div className="testimonial-author d-flex gap-3 align-items-center">
                        <div className="author-img"><img className="rounded-circle img-fluid" src="assets/images/person-sq-5-min.jpg" alt="FreeBootstrap.net image placeholder" /></div>
                        <div className="lh-base"><strong className="d-block">Michael Rodriguez</strong><span>Investor</span></div>
                    </div>
                    </div>
                </div>
                <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div className="testimonial-author d-flex gap-3 align-items-center">
                        <div className="author-img"><img className="rounded-circle img-fluid" src="assets/images/person-sq-3-min.jpg" alt="FreeBootstrap.net image placeholder"/></div>
                        <div className="lh-base"><strong className="d-block">Sarah Lee</strong><span>College Student</span></div>
                    </div>
                    </div>
                </div>
                <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div className="testimonial-author d-flex gap-3 align-items-center">
                        <div className="author-img"><img className="rounded-circle img-fluid" src="assets/images/person-sq-7-min.jpg" alt="FreeBootstrap.net image placeholder" /></div>
                        <div className="lh-base"><strong className="d-block">James Kim</strong><span>IT Consultant</span></div>
                    </div>
                    </div>
                </div>
                <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div className="testimonial-author d-flex gap-3 align-items-center">
                        <div className="author-img"><img className="rounded-circle img-fluid" src="assets/images/person-sq-8-min.jpg" alt="FreeBootstrap.net image placeholder" /></div>
                        <div className="lh-base"><strong className="d-block">Laura Brown</strong><span>Entrepreneur</span></div>
                    </div>
                    </div>
                </div>
                </div>
            ...
            <div className="container">
                ...
                <div className="col-xl-4 justify-content-start justify-content-xl-end quick-links d-flex flex-column flex-xl-row text-center text-xl-start gap-3"><a href="#">Terms and Conditions</a><a href="#">Privacy Policy</a><a href="#">Cookie Policy</a></div>
                </div>
            </div>
            </footer>
            {/*<!-- End Footer--> */}
